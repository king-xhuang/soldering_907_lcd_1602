...
/*!
 *  @brief  Configures to INA219 to be able to measure up 320mv shunt voltage 
 *         and NO Bus voltage 
 *  @note   no shunt resistor is present
 */
void Adafruit_INA219::setCalibration_NO_BUS_320mv() {
  // By default we use a pretty huge range for the input voltage,
  // which probably isn't the most appropriate choice for system
  // that don't use a lot of power.  But all of the calculations
  // are shown below if you want to change the settings.  You will
...
/*!
 *  @brief  Configures to INA219 to be able to measure up 40mv shunt voltage 
 *         and NO Bus voltage 
 *  @note   no shunt resistor is present
 */
void Adafruit_INA219::setCalibration_NO_BUS_40mv(){
...
float Adafruit_INA219::getShuntVoltage_mV() {
  ...
  Serial.print("Shunt Voltage raw: "); Serial.print(value); Serial.println(" LSB");
  return value * 0.01;
}
